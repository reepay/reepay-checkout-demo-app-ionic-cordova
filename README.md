...
This is an example of Reepay Checkout using [Ionic v8.6.4](https://ionicframework.com/docs/cli) & [Cordova v12.0.0](https://cordova.apache.org/#getstarted) & [Angular v19.2.14](https://angular.io/cli/update).
